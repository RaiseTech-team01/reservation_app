...
RSpec.describe "Api::V1::Auth::Sessions", type: :request do # rubocop:disable Metrics/BlockLength
  describe "POST /api/v1/auth/sign_in" do # rubocop:disable Metrics/BlockLength
