            ...
            <form class="row g-3 needs-validation" novalidate>
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  required
                />
                <div class="invalid-feedback">ふりがなを記載してください。</div>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <label for="fax" class="form-label"
                  >FAX番号 <span class="text-muted">必須</span></label
                >
                <input
                  type="tel"
                  class="form-control"
                  ...
                  required
                />
                <div class="invalid-feedback">FAX番号を記載してください。</div>
              </div>
              <div class="col-12">
                <label for="postal-code" class="form-label"
                  >郵便番号 <span class="text-muted">必須</span></label
                >
                <input
                  type="number"
                  class="form-control"
                  ...
                  required
                />
                <div class="invalid-feedback">郵便番号を記載してください。</div>
              </div>
              <div class="col-12">
                <label for="address" class="form-label"
                  >店舗住所 <span class="text-muted">必須</span></label
                >
                <input
                  type="text"
                  class="form-control"
              ...
              <div class="col-12">
                <label for="store-url" class="form-label"
                  >店舗URL <span class="text-muted">必須</span></label
                >
                <input
                  type="url"
                  class="form-control"
              ...
              <div class="col-12">
                ...
                <input
                  ...
                  required
                />
                <div class="invalid-feedback">店舗名を記載してください。</div>
              </div>
              <div class="col-12">
                <label for="sear-num" class="form-label"
                  >座席数 <span class="text-muted">必須</span></label
                >
                <input
                  type="number"
                  class="form-control"
                  ...
                  required
                />
                <div class="invalid-feedback">座席数を記載してください。</div>
              </div>
              <div class="col-12">
                <label for="genre" class="form-label"
                  >業態 <span class="text-muted">必須</span></label
                >
                <input
                  type="text"
                  class="form-control"
                  ...
                  required
                />
                <div class="invalid-feedback">業態を記載してください。</div>
              </div>
              <div class="col-12">
                <label for="responsible-party" class="form-label"
                  >責任者名 <span class="text-muted">必須</span></label
                >
                <input
                  type="text"
                  class="form-control"
