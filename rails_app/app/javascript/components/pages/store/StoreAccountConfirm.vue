        ...
        <div class="container">
            <main>
                <div class="mt-10 py-5 text-center">
                    <h2>店舗アカウント登録確認</h2>
                    <p class="lead">
                        お客様の店舗用のアカウントを登録いたします。<br />内容の確認をお願いいたします。
                    </p>
                </div>
                        ...
                        >
                            <div class="row g-3">
                                <div class="col-12">
                                    <h4>名前</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.name }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>ふりがな</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.furigana }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>メールアドレス</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.email }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>パスワード</h4>
                                ...
                                <div class="col-12">
                                    <h4>電話番号</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.tel }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>FAX番号</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.fax }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>郵便番号</h4>
                                    <p class="">
                                        {{
                                            registrationStoreUserData.postal_code
                                        }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>店舗住所</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.address }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>店舗URL</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.url }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>店舗名</h4>
                                    <p class="">
                                        {{
                                            registrationStoreUserData.restaurant
                                        }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>座席数</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.seat }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>業態</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.genre }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>責任者名</h4>
                                    <p class="">
                                        {{
                                            registrationStoreUserData.responsible_party
                                        }}
                                    </p>
                                </div>
                                <div class="col-12">
                                    <h4>その他</h4>
                                    <p class="">
                                        {{ registrationStoreUserData.other }}
                                    </p>
                                </div>
                            </div>
                        </form>
...
export default {
    ...
    methods: {
        ...
        getHiddenPasswordString(isConfirmation) {
            const passwordLen = isConfirmation
                ? this.$store.getters.registrationStoreUserData
    ...
    computed: {
        ...mapGetters(["registrationStoreUserData"]),
    },
};
</script>
