      ...
      <div class="bg-gray-300 info-container">
        <div>
          <h3 class="mt-10 ml-4 text-xl text-blue-800">
            ...
            <span> > </span>
            <a class="font-bold hover:text-blue-500" href="/sign_up">新規登録確認</a>
          </h3>
        </div>
        <div class="mt-16">
          <div>
        ...
        <div>
          ...
          <form>
            ...
            <div class="text-center space-x-4 md:space-x-8 mt-14 mb-28">
              ...
              <input class="inline-block w-2/5 py-2 rounded-xl font-bold bg-yellow-300 text-4xl text-blue-800 cursor-pointer hover:bg-yellow-200 hover:text-blue-600 active:bg-red-200" @click.prevent="toForm" type="button" value="戻　る" />
            </div>
          </form>
        </div>
      </div>
